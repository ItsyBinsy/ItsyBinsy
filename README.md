...
- Consulting environment across multiple client projects, working alongside senior engineers in Agile/Scrum sprints
- Contributed to TLL Daily Drill (ReactJS + Strapi v5) as part of a team, taking ownership of specific features from Figma to production
- Resolved bug tickets across BF Timesheet, a Blazor WebAssembly + ASP.NET Core system built on CQRS/MediatR architecture
- Used Azure DevOps CI/CD, Azure Repos, and PR-based code review throughout
...
| Project | Type | Stack |
|---|---|---|
| **[Saan Tayo Kakain](https://saantayokakain.today)** | Personal | Next.js · TypeScript · Google Places API · Zustand · Playwright · PWA |
| **[TLL Daily Drill](https://wikaygaling-dev.blackfortconsulting.com)** | Internship | ReactJS · Strapi v5 · Azure DevOps |
